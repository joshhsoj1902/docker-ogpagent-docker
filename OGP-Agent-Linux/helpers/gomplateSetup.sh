...
echo 'GOMPLATE: ' -d $configdatasource -d $globalconfigdatasource -d $homedatasource -d $binddatasource -f $template -o $output

/usr/local/bin/gomplate -d $configdatasource -d $globalconfigdatasource -d $homedatasource -d $binddatasource -f $template -o $output
